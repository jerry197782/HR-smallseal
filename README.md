...
目前2.0版已補齊常用國字標準字體表、jf7000當務字集基本包+命名包+粵語包+日文包(不含匁)、GB/T 2312 、現代漢語常用字表，通用規範漢字表(繁體+簡體)、IICore(不包含乫乭乶乷匁唜巪)、現代漢語通用字表的所有漢字。並增補了一些見於《說文解字》《說文逸字》《說文佚字考》卻未見於“北師大說文小篆”的篆字。
